    ...
    <div id="permission-manager">
        <v-container fluid class='pt-0'>
            <v-btn 
                ...
                dark
            >< Back</v-btn>
            <h1>Curation Group Edit <v-icon color="cyan darken-3" large class="">mdi-account-group</v-icon></h1>
            <div class="subtitle-1">Use the following form to modify an existing curation group. Fill in the fields, and click the 'Update Curation Group' button.</div>
            <v-card
                class="mt-2 pa-0"
            >
