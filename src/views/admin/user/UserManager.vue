<template>
    <div id="permission-manager">
        <v-container fluid class='pt-0'>
            ...
            >< Back</v-btn>
            <h1>User Manager</h1>
            <div class="subtitle-1">Use the table below to view current users. To make changes to an existing user, including changing their status or user class, click on the edit user icon (<v-icon color='info'>mdi-account-edit</v-icon>) in the tools column for the corrensponding user. <strong>Note</strong>: Users will need to logout and then log back in again for changes to be reflected in their access credentials.</div>
...
import { convertPermissionLevelToInteger, isPermitted } from '@/utils/Permission.ts';
