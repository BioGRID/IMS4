<template>
    <div id="permission-manager">
        <v-container fluid class='pt-0'>
            ...
            >< Back</v-btn>
            <h1>Socket Status</h1>
            <div class="subtitle-1">This tool presents a couple of handy tools for checking on the status of the main application websocket.</div>
            <v-alert class='mt-5' :type="socketStatus">
                {{ socketMessage }}
            </v-alert>
            <v-sheet class='pa-3'>
                <h4>Test Socket with Echo</h4>
                <div class="subtitle-2">Type some text into the field below and hit submit. We'll send that message to the server, and it should echo the same message right back to us, if things are working correctly.</div>
                <v-text-field 
                    label="Echo Message"
                    class='mt-5'
